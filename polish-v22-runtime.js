(()=>{
  ...
  const loadUpgrades=async()=>{
    try{
      ...
      await loadScript('platform-foundation-v31.js?v=20260912-foundation3','data-party-foundation-v31');
      await loadScript('content-modes-v31.js?v=20260912-foundation3','data-party-content-modes-v31');
      await loadScript('duel-content-v31.js?v=20260912-duel3','data-party-duel-content-v31');
      loadStyle('duel-v31.css?v=20260912-duel3','duelV31Style');
      await loadScript('duel-games-v31.js?v=20260912-duel3','data-party-duel-games-v31');
      await loadScript('party-director-v31.js?v=20260912-director3','data-party-director-v31');
      await loadScript('foundation-hotfix-v31.js?v=20260912-foundation3','data-party-foundation-hotfix-v31');
      loadStyle('duel-hub-v31.css?v=20260912-duel3','duelHubV31Style');
      await loadScript('duel-hub-v31.js?v=20260912-duel3','data-party-duel-hub-v31');
      await loadScript('identity-v31.js?v=20260912-foundation3','data-party-identity-v31');
