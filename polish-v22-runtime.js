(()=>{
  const installNewNightFix=()=>{
    window.newNight=function(){
      ...
      ['fakePass','fakeDebate','fakeVote','fakeReveal','syncTurn','syncResults','scaleLeader','scaleGuess','scaleReveal','tabooPlay','drawPass','drawTask','drawReveal','bowlPlay','bowlEnd','bombPlay','bombResult','playerPass','playerCard','fiveStage','majorityStage','orderStage','emojiStage','estimateStage','memoryStage','whisperStage'].forEach(hide);
