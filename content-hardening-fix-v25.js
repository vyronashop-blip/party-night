(()=>{
  ...
  add('hq-med-clue-barca','barca','medium','clues','من أنا؟ لاعب برازيلي سجل هدف التعادل لبرشلونة في نهائي دوري الأبطال 2006.','صامويل إيتو',{hints:['لعبت كمهاجم','فزت بدوري الأبطال مع برشلونة','سجلت أمام أرسنال في باريس']});
})();
